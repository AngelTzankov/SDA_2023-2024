...
те седят на моста, докато не дойде такъв с отрицателна стойност. 
В момента, в който видим боец с отрицателна стойност, той трябва да 
победи всички бойци с позитивна стойност, които са на моста. Това трябва 
да стане точно в реда, в който те ще излязат от стека. 
За всеки боец на върха на стека сравняваме неговата сила с тази на 
боеца с отрицателна стойност и го премахваме, ако е по-слаб. Това 
...
в първия. Алтернативно може да се използва и дек.
*/
